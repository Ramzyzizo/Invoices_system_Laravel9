<!-- main-sidebar -->
		...
		<aside class="app-sidebar sidebar-scroll">
			<div class="main-sidebar-header active">
				<a class="desktop-logo logo-light active" href="<?php echo e(url('/' . $page='index')); ?>"><img src="<?php echo e(URL::asset('assets/img/brand/favicon_invoices.png')); ?>" style="height: 45px" class="main-logo" alt="logo"></a>
			...
			<div class="main-sidemenu">
					...
					<div class="dropdown user-pro-body">
						<div class="">
							<img alt="user-img" class="avatar avatar-xl brround"
                                 src="<?php echo e(URL::asset('assets/img/faces/6.png')); ?>"><span class="avatar-status profile-status bg-green"></span>
						</div>
						<div class="user-info">
				...
				<ul class="side-menu">
					<li style="font-size:13px" class="side-item side-item-category ">برنامج الفواتير</li>
					<li class="slide">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('الفواتير المدفوعة')): ?>
                                <li><a class="slide-item" href="<?php echo e(url('/' . $page='paid_invoices')); ?>">الفواتير المدفوعه</a></li>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('الفواتير الغير المدفوعة')): ?>
                                    <li><a class="slide-item" href="<?php echo e(url('/' . $page='unpaid_invoices')); ?>">الفواتير الغير المدفوعه</a></li>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('الفواتير المدفوعة جزئيا')): ?>
                                    <li><a class="slide-item" href="<?php echo e(url('/' . $page='partialpaid_invoices')); ?>">الفواتير المدفوعه جزئية</a></li>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('ارشيف الفواتير')): ?>
                                    <li><a class="slide-item" href="<?php echo e(url('/' . $page='archived_invoice')); ?>">ارشيف الفواتير</a></li>
                            <?php endif; ?>
						</ul>
					</li>
                    <?php endif; ?>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
                            ...
                            <li><a class="slide-item" href="<?php echo e(url('/' . $page='roles')); ?>">الصلاحيات</a></li>
						    <?php endif; ?>
                        </ul>
					</li>
                    <?php endif; ?>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="<?php echo e(url('/' . $page='products')); ?>">المنتجات</a></li>
                            <?php endif; ?>
...
<!-- main-sidebar -->
<?php /**PATH C:\xampp\htdocs\inovices_proj\resources\views/layouts/main-sidebar.blade.php ENDPATH**/ ?>