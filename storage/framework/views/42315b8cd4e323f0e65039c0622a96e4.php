                                    ...
                                    <td>
                                      <?php if(!empty($user->getRoleNames())): ?>
                                          ...
                                          <a class="badge badge-success"
                                             href="<?php echo e(route('roles.show',DB::table('roles')->where('name',$v)->value('id'))); ?>">
                                              <?php echo e($v); ?>
                ...
                <div class="modal-content modal-content-demo">
                    ...
                    <form action="<?php echo e(route('users.destroy', 'test')); ?>" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <input type="hidden" name="user_id" id="usser_id" value="">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\inovices_proj\resources\views/users/index.blade.php ENDPATH**/ ?>