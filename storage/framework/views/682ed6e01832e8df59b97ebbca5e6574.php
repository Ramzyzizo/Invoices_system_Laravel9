							...
							<div class="main-content-body main-content-body-mail card-body">
								...
								<div class="main-mail-list">
									<div class="main-mail-item unread">
										...
										<div class="main-img-user"><img alt="" src="<?php echo e(URL::asset('assets/img/faces/5.jpg')); ?>"></div>
									...
									<div class="main-mail-item unread">
										...
										<div class="main-img-user"><img alt="" src="<?php echo e(URL::asset('assets/img/faces/2.jpg')); ?>"></div>
										<div class="main-mail-body">
											<div class="main-mail-from">
												Albert Ansing
											</div>
									...
									<div class="main-mail-item">
										...
										<div class="main-img-user"><img alt="" src="<?php echo e(URL::asset('assets/img/faces/9.jpg')); ?>"></div>
										<div class="main-mail-body">
											<div class="main-mail-from">
												Carla Guden
											</div>
									...
									<div class="main-mail-item unread">
										...
										<div class="main-img-user"><img alt="" src="<?php echo e(URL::asset('assets/img/faces/10.jpg')); ?>"></div>
										<div class="main-mail-body">
											<div class="main-mail-from">
												Reven Galeon
											</div>
									...
									<div class="main-mail-item">
										...
										<div class="main-img-user"><img alt="" src="<?php echo e(URL::asset('assets/img/faces/12.jpg')); ?>"></div>
										<div class="main-mail-body">
											<div class="main-mail-from">
												Elisse Tan
											</div>
									...
									<div class="main-mail-item">
										...
										<div class="main-img-user"><img alt="" src="<?php echo e(URL::asset('assets/img/faces/14.jpg')); ?>"></div>
										<div class="main-mail-body">
											<div class="main-mail-from">
												Marianne Audrey
											</div>
									...
									<div class="main-mail-item">
										...
										<div class="main-img-user"><img alt="" src="<?php echo e(URL::asset('assets/img/faces/15.jpg')); ?>"></div>
										<div class="main-mail-body">
											<div class="main-mail-from">
												Raffy Godinez
											</div>
									...
									<div class="main-mail-item">
										...
										<div class="main-img-user"><img alt="" src="<?php echo e(URL::asset('assets/img/faces/7.jpg')); ?>"></div>
										<div class="main-mail-body">
											<div class="main-mail-from">
												Allan Cadungog
											</div>
									...
									<div class="main-mail-item border-bottom-0">
										...
										<div class="main-img-user"><img alt="" src="<?php echo e(URL::asset('assets/img/faces/1.jpg')); ?>"></div>
										<div class="main-mail-body">
											<div class="main-mail-from">
												Jove Guden
											</div>
...
<script src="<?php echo e(URL::asset('assets/js/check-all-mail.js')); ?>"></script>
<!--Internal Apexchart js-->
<script src="<?php echo e(URL::asset('assets/js/apexcharts.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\inovices_proj\resources\views/mail.blade.php ENDPATH**/ ?>