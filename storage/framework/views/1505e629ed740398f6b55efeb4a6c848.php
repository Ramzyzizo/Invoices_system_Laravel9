                                    ...
                                    <div class="">
                                        <table id="example" class="table  key-buttons text-md-nowrap">
                                            ...
                                            <tr>
                                                ...
                                                <th class="border-bottom-0">المتج</th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                   <a href="<?php echo e(url('InvoicesDetails')); ?>/<?php echo e($invoice->id); ?>">
                                                        <?php echo e($invoice->section->section_name); ?></td>
                                                    </a>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu tx-13">
                                                                <a class="dropdown-item"
                                                                   href=" <?php echo e(url('invoices')); ?>/<?php echo e($invoice->id); ?>/edit">تعديل
                                                                    الفاتورة</a>

                                                                <a class="dropdown-item"
                                                                   href="#" data-invoice_id="<?php echo e($invoice->id); ?>"
                                                                   data-toggle="modal" data-target="#delete_invoice"><i
                                                                        class="text-danger fas fa-trash-alt"></i>&nbsp;&nbsp;حذف
                                                                    الفاتورة</a>

                                                                <a class="dropdown-item"
                                                                   href="<?php echo e(URL::route('invoices.show', [$invoice->id])); ?>"><i
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\inovices_proj\resources\views/invoices/partial_paid.blade.php ENDPATH**/ ?>