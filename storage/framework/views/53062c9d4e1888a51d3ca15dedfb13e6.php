...
<?php $__env->startSection('content'); ?>
    ...
    <?php if(session()->has('added')): ?>
        <div class="alert alert-success  fade show" role="alert">
            <strong><?php echo e(session()->get('added')); ?></strong>
            <button type="button" class="close float-left" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
        </div>
        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                ...
                <div class="card-body">
                    <div class="card-body">
                        <div class=" col-xl-3">
                            <a class="modal-effect btn btn-outline-primary btn-block " style="font-size: 20px" data-effect="effect-scale" data-toggle="modal" href="#modaldemo8">اضافة قسم</a>
                        </div>
                    </div>
                    <div class="">
                            ...
                            <div class="modal-body">
                                <form action="<?php echo e(route('sections.store')); ?>" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" name="description" class="form-control" id="section_name"></textarea>

                                    </div>
                                    <div class="model-footer">
                                            <button type="submit" class="btn ripple btn-primary"> اضافة قسم</button>
                                    </div>
                                </form>
                             </div>
                        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\inovices_proj\resources\views/sections/section.blade.php ENDPATH**/ ?>