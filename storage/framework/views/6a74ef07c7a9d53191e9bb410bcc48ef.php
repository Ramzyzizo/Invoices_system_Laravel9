					...
					<div class="main-header-right">
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
								...
								<div class="dropdown-menu">
									...
									<div class="main-message-list chat-scroll">
										<a href="#" class="p-3 d-flex border-bottom">
											...
											<div class="wd-90p">
												<div class="d-flex">
													<h5 class="mb-1 name"><?php echo e(Auth::user()->name); ?></h5>
												</div>
							...
							<div class="dropdown nav-item main-header-notification">
                                <?php $users = Illuminate\Support\Facades\Auth::user();
//                                        $unreadNotifications = Illuminate\Support\Facades\DB::table('notifications')->whereNull('read_at')->get();<!---->
                                $unreadNotifications = auth()->user()->notifications()->whereNull('read_at')->get(); ?>
								<a class="new nav-link" href="#">
								<svg xmlns="http://www.w3.org/2000/svg" class="header-icon-svgs" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                     stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                     class="feather feather-bell"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"></path><path d="M13.73 21a2 2 0 0 1-3.46 0"></path></svg>
								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										...
										<div class="d-flex">
											<h6 class="dropdown-title mb-1 tx-15 text-white font-weight-semibold">Notifications الاشعارات</h6>
											<a class="badge badge-pill badge-warning mr-auto my-auto float-left"
                                               href="<?php echo e(url('markasreadall')); ?>">
                                                 تغير كتم مشاهدتها
                                           </a>
										</div>
										<p class="dropdown-title-text subtext mb-0 text-white op-9 pb-0 tx-12 " > عدد الاشعارات الغير مقروئة :
                                            <b id="notifications_count"> <?php echo e($unreadNotifications->count()); ?></b>
                                        </p>
									</div>
									...
									<div class="main-notification-list Notification-scroll" id="unreadNotifications">
                                        ...
                                        <?php $__currentLoopData = $users->unreadNotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                        <a class="d-flex p-3 border-bottom" href="<?php echo e(url('markasread/'.$notification->notifiable_id)); ?>">
											...
											<div class="mr-3">
												...
												<div class="notification-subtext"><?php echo e($notification->created_at->diffForHumans()); ?></div>
											</div>
											<div class="mr-auto" >
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								<a class="profile-user d-flex" href=""><img alt="" src="<?php echo e(URL::asset('assets/img/faces/6.png')); ?>"></a>
								<div class="dropdown-menu">
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
											<div class="main-img-user"><img alt="" src="<?php echo e(URL::asset('assets/img/faces/6.png')); ?>" class=""></div>
...
<!-- /main-header -->
<?php /**PATH C:\xampp\htdocs\inovices_proj\resources\views/layouts/main-header.blade.php ENDPATH**/ ?>