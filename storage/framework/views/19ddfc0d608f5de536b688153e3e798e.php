                    ...
                    <div class="row row-sm">
                                                        ...
                                                        <div class="dropdown-menu tx-13">
                                                            <a class="dropdown-item" href="#" data-invoice_id="<?php echo e($invoice->id); ?>"
                                                               data-toggle="modal" data-target="#Transfer_invoice"><i
                                                                    class="text-warning fas fa-exchange-alt"></i>&nbsp;&nbsp;استرجاع الفاتورة</a>
                        ...
                        <div class="modal fade" id="Transfer_invoice" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">استرجاع الفاتورة</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    ...
                                    <div class="modal-body">
                                        هل انت متاكد من عملية الاسترجاع ؟
                                        <input type="hidden" name="invoice_id" id="invoice_id" value="">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\inovices_proj\resources\views/invoices/archived_invoices.blade.php ENDPATH**/ ?>