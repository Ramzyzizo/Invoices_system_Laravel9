...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('invoices.status',$invoice->id)}}" method="post" enctype="multipart/form-data"
                          autocomplete="off">
                        {{method_field('GET')}}
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select name="section_id" class="form-control SelectBox" readonly >
                                    <!--placeholder-->
                            ...
                            <div class="col">
                                ...
                                <select id="product" name="product" class="form-control SelectBox" readonly="" >
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select name="Rate_VAT" id="Rate_VAT" class="form-control" readonly="">
                                    <!--placeholder-->
                                    <option value="{{ $invoice->Rate_VAT}}" selected readonly>{{$invoice->Rate_VAT}}</option>
                                </select>
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" value="{{$invoice->Value_VAT}}" class="form-control" id="Value_VAT"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <textarea class="form-control" value="{{$invoice->note}}" id="exampleTextarea"
                                          name="note" rows="3" readonly>{{$invoice->note}}</textarea>
                            </div>
                        </div><br>
                        {{-- 6 --}}
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select name="status_id" class="form-control SelectBox" required>
