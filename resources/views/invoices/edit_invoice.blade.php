                    ...
                    <form action="{{url('invoices').'/'.$invoice->id}}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" value="{{old('Value_VAT', $invoice->Value_VAT) }}" class="form-control" id="Value_VAT" name="Value_VAT" readonly>
                            </div>

                            <div class="col">
                                <label for="inputName" class="control-label">الاجمالي شامل الضريبة</label>
                                <input type="text" value="{{old('Total', $invoice->Total) }}" class="form-control" id="Total" name="Total" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <textarea class="form-control" value="{{old('note', $invoice_details->note) }}" id="exampleTextarea" name="note" rows="3">{{$invoice_details->note}}</textarea>
                            </div>
                        </div><br>
