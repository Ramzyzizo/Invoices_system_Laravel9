                        ...
                        <div class="col-xl-13">
                            <div class="card mg-b-20">
                                <div class="card-header pb-2">
                                    ...
                                    @endcan
                                    @can('تصدير EXCEL')
                                    <a href="export_invoices" class="modal-effect btn btn-sm btn-primary" style="color:white"><i
                                                class="fas fa-file-download"></i>&nbsp; تصدير ايكسيل</a>
                                    @endcan
                                </div>
                                <div class="card-body">
                                    <div class="">
