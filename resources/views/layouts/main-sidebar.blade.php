<!-- main-sidebar -->
		...
		<aside class="app-sidebar sidebar-scroll">
			<div class="main-sidebar-header active">
				<a class="desktop-logo logo-light active" href="{{ url('/' . $page='index') }}"><img src="{{URL::asset('assets/img/brand/favicon_invoices.png')}}" style="height: 45px" class="main-logo" alt="logo"></a>
					...
					<div class="dropdown user-pro-body">
						<div class="">
							<img alt="user-img" class="avatar avatar-xl brround"
                                 src="{{URL::asset('assets/img/faces/6.png')}}"><span class="avatar-status profile-status bg-green"></span>
						</div>
						<div class="user-info">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
                            ...
                            @can('الفواتير الغير المدفوعة')
                                    <li><a class="slide-item" href="{{ url('/' . $page='unpaid_invoices') }}">الفواتير الغير المدفوعه</a></li>
                            @endcan
                            @can('الفواتير المدفوعة جزئيا')
                                    <li><a class="slide-item" href="{{ url('/' . $page='partialpaid_invoices') }}">الفواتير المدفوعه جزئية</a></li>
                            @endcan
                            @can('ارشيف الفواتير')
                                    <li><a class="slide-item" href="{{ url('/' . $page='archived_invoice') }}">ارشيف الفواتير</a></li>
                            @endcan
						</ul>
					</li>
                    @endcan
