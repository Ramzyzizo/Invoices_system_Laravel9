...
{{--                                    @foreach($users as $user)--}}
                                        ...
                                        <a class="d-flex p-3 border-bottom" href="{{url('markasread/'.$notification->notifiable_id)}}">
