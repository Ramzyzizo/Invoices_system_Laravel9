                        ...
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    {{$all=number_format(\App\Models\invoices::sum('Total'),2)}} $
                                </h4>
                            ...
                            <span class="float-right my-auto mr-auto">
											<span class="text-white op-7">
                                                ...
                                                @if($all==0)
                                                    0
                                                @else
                                            {{$value_1=number_format((int)\App\Models\invoices::where('invoice_Date','>=',Carbon\Carbon::now()->subWeek()->endOfWeek())
                ...
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    {{$not_paid=number_format(\App\Models\invoices::where('status_id',2)->sum('Total'),2)}} $
                                </h4>
                                <p class="mb-0 tx-12 text-white op-7">
                                    {{\App\Models\invoices::where('status_id',2)->count()}}
                                </p>
                            </div>
                            <span class="float-right my-auto mr-auto">
											<span class="text-white op-7">
                                                ...
                                                @if($not_paid==0)
                                                    0
                                                @else
                                            {{$value=number_format((int)\App\Models\invoices::where('invoice_Date','>=',Carbon\Carbon::now()->subWeek()->endOfWeek())
                ...
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    {{$paid=number_format(\App\Models\invoices::where('status_id',1)->sum('Total'),2)}} $
                                </h4>
                                <p class="mb-0 tx-12 text-white op-7">
                                    {{\App\Models\invoices::where('status_id',1)->count()}}
                                </p>
                            </div>
                            <span class="float-right my-auto mr-auto">
									<span class="text-white op-7">
                                        ...
                                        @if($paid==0)
                                            0
                                        @else
                                            {{$value_2=number_format((int)\App\Models\invoices::where('invoice_Date','>=',Carbon\Carbon::now()->subWeek()->endOfWeek())
                ...
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    {{$partial_paid=number_format(\App\Models\invoices::where('status_id',3)->sum('Total'),2)??0}} $
                                </h4>
                                <p class="mb-0 tx-12 text-white op-7">
                                    {{\App\Models\invoices::where('status_id',3)->count()}}
                                </p>
                            </div>
                            <span class="float-right my-auto mr-auto">
											<span class="text-white op-7">
                                            Last Week Effect
                                                ...
                                                @if($partial_paid==0)
                                                    0
                                                @else
                                            {{$value_3=number_format((int)\App\Models\invoices::where('invoice_Date','>=',Carbon\Carbon::now()->subWeek()->endOfWeek())
